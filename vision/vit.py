# %%
# A very simple implementation of ViT.
# Source: https://openreview.net/pdf?id=YicbFdNTTy
# and: https://github.com/lucidrains/vit-pytorch/blob/main/vit_pytorch/vit.py
